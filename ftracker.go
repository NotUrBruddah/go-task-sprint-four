...
const (
	...
	runningCaloriesMeanSpeedMultiplier = 18    // множитель средней скорости для подсчета калорий при беге.
	runningCaloriesMeanSpeedShift      = 1.79  // среднее количество сжигаемых калорий при беге.
	walkingCaloriesWeightMultiplier    = 0.035 // множитель массы тела для подсчета калорий при ходьбе.
	walkingSpeedHeightMultiplier       = 0.029 // множитель роста для подсчета калорий при ходьбе.
